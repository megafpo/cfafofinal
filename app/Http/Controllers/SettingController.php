    ...
    public function sendTestmail(Request $request)
    {
        ...
        try {
            ...
            Mail::send('emails.testEmail', $data, function ($message) use ($data) {
                $message->subject('Test Email from frutri');
