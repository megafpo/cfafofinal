...
@section("title") Update frutri - Dashboard
@endsection
@section('content')
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                <span class="font-weight-bold mr-2">frutri Updater</span>
                @if($versionMsg != null)
...
<div class="content">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.uploadUpdateZipFile') }}" enctype="multipart/form-data"  class="dropzone" id="frutri_uploader">
                @csrf
            </form>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-4">
                    <button onClick="location.href='{{ route('admin.updatefrutriNow') }}'" class="btn btn-primary btn-lg btn-ladda btn-ladda-spinner" data-style="expand-left" data-spinner-color="#fff" data-spinner-size="20" id="btnUpdateNowConfirm" data-spinner-lines="9" style="width: 100%; height: 3rem; font-size: 1.1rem;">Update Now</button>
                </div>
...
<script>
    ...
    $(function() {
       ...
       var myDropzone =  $("#frutri_uploader").dropzone({
