                            ...
                            <div class="tab-pane fade" id="deliverySettings">
                                ...
                                <div id="timeslot" style="display: none">	
                                    <div class="form-group">	
                                        <div class="col-lg-12 row">	
                                            ...
                                            <div class="col-lg-2">	
                                                <div class="checkbox checkbox-switchery mt-2">	
                                                    <label>	
                                                    <input value="true" type="checkbox" class="switchery-primary" name="enable_timeslot1" {{ $restaurant->enable_timeslot1 ? 'checked="checked"' : '' }}>	
                                                    </label>	
                                                </div>	
                                            </div>	
                                        </div>	
                                    ...
                                    <div class="form-group">	
                                        <div class="col-lg-12 row">	
                                            ...
                                            <div class="col-lg-2">	
                                                <div class="checkbox checkbox-switchery mt-2">	
                                                    <label>	
                                                    <input value="true" type="checkbox" class="switchery-primary" name="enable_timeslot2" {{ $restaurant->enable_timeslot2 ? 'checked="checked"' : '' }} >	
                                                    </label>	
                                                </div>	
                                            </div>	
                                        </div>	
                                    ...
                                    <div class="form-group">	
                                        <div class="col-lg-12 row">	
                                            ...
                                            <div class="col-lg-2">	
                                                <div class="checkbox checkbox-switchery mt-2">	
                                                    <label>	
                                                    <input value="true" type="checkbox" class="switchery-primary"  name="enable_timeslot3" {{ $restaurant->enable_timeslot3 ? 'checked="checked"' : '' }}>	
                                                    </label>	
                                                </div>	
                                            </div>	
                                        </div>	
                                    ...
                                    <div class="form-group">	
                                        <div class="col-lg-12 row">	
                                            <div class="col-lg-4">	
                                                <label class="col-lg-12 col-form-label">Delivery Limit:</label>	
                                            </div>	
                                            <div class="col-lg-6">	
    ...
    $(function () {
      ...
      if (Array.prototype.forEach) {
       ...
       $('.base_delivery_charge').numeric({ allowThouSep:false, maxDecimalPlaces: 2, allowMinus: false });
        ...
        $('.express_delivery_charge').numeric({ allowThouSep:false, maxDecimalPlaces: 2 });	
