            ...
            <div class="card-body">
                <form action="{{ route('admin.saveSettings') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <span class="help-text small"> To change the Progressive Web Application name, refer to
                                    this <a href="https://docs.frutri.com/configurations/pwa-configurations"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <span class="help-text small text-danger">Cronjob setup is require. <a
                                        href="https://docs.frutri.com/configurations/store-scheduling-open-close-times"
                                        target="_blank">Watch
                                        Video</a></span>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="designSettings">
                        ...
                        @if(config('setting.iHavefrutriStoreApp') == "true")
                        <div class="form-group row">
                    ...
                    <div class="tab-pane fade" id="pushNotificationSettings">
                        ...
                        <span class="help-text"><a
                                href="https://docs.frutri.com/configurations/push-notification-keys"
                        ...
                        <span><strong class="text-danger">IMPORTANT</strong> To learn how Subscribers, Push
                            Notifications, and Alerts work <a
                                href="https://docs.frutri.com/faqs/push-notifications-and-alerts"
                    ...
                    <div class="tab-pane fade" id="mapSettings">
                        ...
                        <hr>
                        <a href="https://docs.frutri.com/configurations/google-maps-api-keys" target="_blank"
                            rel="nofollow">Click
                            Here</a>
                    ...
                    <div class="tab-pane fade" id="paymentGatewaySettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <p class="mb-0"><a href="https://docs.frutri.com/faqs/razorpay-webhooks"
                                        target="_blank">Click
                                        here</a> to
                                    learn how to setup Webhooks for Razorpay</p>
                                <p class="mb-0 text-warning">Webhooks setup is <b>mandatory</b> for frutri <p>
                            </div>
                        </div>
                        <hr>
                                ...
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        ...
                                        <b><span class="mt-1"><span class="text-danger"> IMPORTANT: </span>Donot enable
                                                ...
                                                href="https://docs.frutri.com/configurations/google-distance-matrix-api"
                ...
                --}}
                    ...
                    <div class="tab-pane fade" id="androidAppSettings">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have frutri Customer Android App
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work properly if this config is not correctly set. If you have the frutri Customer Android App, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHavefrutriAndroidApp')=="true" ) checked="checked"
                                            @endif name="iHavefrutriAndroidApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.frutri.com/store/android-customer-mobile-application"
                                                target="_blank">frutri Customer Android App</a></p>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have frutri Delivery Android App
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work properly if this config is not correctly set. If you have the frutri Delivery App, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHavefrutriDeliveryApp')=="true" ) checked="checked"
                                            @endif name="iHavefrutriDeliveryApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.frutri.com/store/android-delivery-mobile-application"
                                                target="_blank">frutri Delivery Android App</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the app</p>
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have frutri Store Android App
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work properly if this config is not correctly set. If you have the frutri Store App, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHavefrutriStoreApp')=="true" ) checked="checked"
                                            @endif name="iHavefrutriStoreApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.frutri.com/store/store-partner-application-android"
                                                target="_blank">frutri Store Android App</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the app</p>
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have frutri SocketPush Service
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                ...
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            ...
                                            name="hasSocketPush">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.frutri.com/store/socketpush-service-for-frutri"
                                                target="_blank">frutri SocketPush Service</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
